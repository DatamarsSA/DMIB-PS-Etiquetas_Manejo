...
namespace ProductionData
{
    ...
    public class FScustomVars
    {
        ...
        public string serialize()
        {
            ...
            {
                string ret = "";
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(List<FSlaserVars>));
        ...
        public void deserialize(string message)
        {
            try
            {
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(FSlaserVars));
