    ...
    public partial class STXQuickTag_Sheep : UserControl, ISpecies
    {
        ...
        private void setVisualsEDM()
        {
            try
            {
                ...
                this.gbPrefix.Visible = true;
                this.gbFixed.Visible = true;
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        private void setVisualsButton()
        {
            try
            {
                ...
                this.pPos2.Controls.Add(this.gbPrefix);
                this.pPos3.Controls.Add(this.gbFixed);
        ...
        private void setVisualsTagFasterS()
        {
            try
            {
                this.clearPanels();
                this.pPos1.Controls.Add(this.gbBarcode);
                this.pPos2.Controls.Add(this.gbTagFasterS);
                this.pPos3.Controls.Add(this.gbPrefix);
                this.pPos4.Controls.Add(this.gbFixed);
                this.gbBarcode.Visible = true;
